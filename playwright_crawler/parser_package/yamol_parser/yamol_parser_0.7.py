...
#############################以下為內部方法的實作##########################################
    ...
    '''
        ...
        div_open = r'<div style="border: 1px solid; border-radius: 40px; border-color: #b58097; padding: 8px 8px 11px 20px; margin-top: 7px; background-color:AliceBlue;" class=<class>>'
